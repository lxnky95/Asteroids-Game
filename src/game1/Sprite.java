...
public class Sprite {
    public static Image ASTEROID1, MILKYWAY1, GAMEOVER1,HEART1,SKULL1;
    static {
        try {
            ASTEROID1 = ImageManager.loadImage("asteroid1");
            MILKYWAY1 = ImageManager.loadImage("milkyway1");
            GAMEOVER1 = ImageManager.loadImage("gameover1");
            HEART1 = ImageManager.loadImage("heart1");
            SKULL1 = ImageManager.loadImage("skull1");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
